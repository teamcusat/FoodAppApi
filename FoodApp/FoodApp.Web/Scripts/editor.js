...
//Err Message Div
        ...
        createModal: function(modalId, modalHeader, modalBody, onSave) {
            //CreateIndustryCategory a Modal for the button.		
            var modalTrigger = $('<a/>', {
                href: "#" + modalId,
                role: "button",
        ...
        createMenuItem: function(itemSettings, options, returnElement) {
            ...
            //1.CreateIndustryCategory Select Options using Bootstrap Dropdown.
            //2.CreateIndustryCategory modal dialog using bootstrap options
            //3.CreateIndustryCategory menubar buttons binded with corresponding event actions
