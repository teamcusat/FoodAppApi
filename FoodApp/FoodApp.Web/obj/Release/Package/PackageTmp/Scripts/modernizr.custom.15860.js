 ...
 * Build: http://modernizr.com/download/#-fontface-backgroundsize-borderimage-borderradius-boxshadow-flexbox-flexboxlegacy-opacity-textshadow-cssanimations-csscolumns-generatedcontent-cssgradients-cssreflections-csstransitions-applicationcache-canvas-canvastext-hashchange-input-inputtypes-shiv-cssclasses-teststyles-testprop-testallprops-hasevent-prefixes-domprefixes-load
 */
;
window.Modernizr = function(a, b, c) {
    function B(a) { j.cssText = a; }

    function C(a, b) { return B(n.join(a + ";") + (b || "")); }
    ...
    !D(z, "undefined") && !D(z.call, "undefined") ? A = function(a, b) { return z.call(a, b); } : A = function(a, b) { return b in a && D(a.constructor.prototype[b], "undefined"); }, Function.prototype.bind || (Function.prototype.bind = function(b) {
        ...
        return e;
    }), r.flexbox = function() { return H("flexWrap"); }, r.flexboxlegacy = function() { return H("boxDirection"); }, r.canvas = function() {
        var a = b.createElement("canvas");
        return!!a.getContext && !!a.getContext("2d");
    }, r.canvastext = function() { return!!e.canvas && !!D(b.createElement("canvas").getContext("2d").fillText, "function"); }, r.hashchange = function() { return y("hashchange", a) && (b.documentMode === c || b.documentMode > 7); }, r.backgroundsize = function() { return H("backgroundSize"); }, r.borderimage = function() { return H("borderImage"); }, r.borderradius = function() { return H("borderRadius"); }, r.boxshadow = function() { return H("boxShadow"); }, r.textshadow = function() { return b.createElement("div").style.textShadow === ""; }, r.opacity = function() { return C("opacity:.55"), /^0.55$/.test(j.opacity); }, r.cssanimations = function() { return H("animationName"); }, r.csscolumns = function() { return H("columnCount"); }, r.cssgradients = function() {
        var a = "background-image:", b = "gradient(linear,left top,right bottom,from(#9f9),to(white));", c = "linear-gradient(left top,#9f9, white);";
        return B((a + "-webkit- ".split(" ").join(b + a) + n.join(c + a)).slice(0, -a.length)), E(j.backgroundImage, "gradient");
    }, r.cssreflections = function() { return H("boxReflect"); }, r.csstransitions = function() { return H("transition"); }, r.fontface = function() {
        var a;
    ...
    }, r.applicationcache = function() { return!!a.applicationCache; };
    ...
    return e.input || I(), e.addTest = function(a, b) {
        ...
        a.html5 = r, q(b);
    }(this, b), e._version = d, e._prefixes = n, e._domPrefixes = q, e._cssomPrefixes = p, e.hasEvent = y, e.testProp = function(a) { return F([a]); }, e.testAllProps = H, e.testStyles = x, g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (f ? " js " + u.join(" ") : ""), e;
